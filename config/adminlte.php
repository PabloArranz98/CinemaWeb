    ...
    */
    ...
    'menu' => [
        ...
        [
            ...
            'can'         => 'admin.generos.index'
        ],
       
        
        ['header' => 'OPCIONES DE WEB(PELICULAS)'],
        [
        ...
        [
            'text'       => 'Añadir nueva película',
            'route'        => 'admin.peliculas.create',
            'icon'         => 'fas fa-fw fa-file',
            'can'         => 'admin.peliculas.create'
        ],

        ['header' => 'OPCIONES DE WEB(SERIES)'],
        ...
        ['header' => 'OPCIONES DE WEB(NOTICIAS)'],
